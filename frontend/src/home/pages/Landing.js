      ...
      <main>
        <div  className="relative pt-16 pb-32 flex content-center items-center justify-center"
          ...
          <div className="absolute top-0 w-full h-full bg-center bg-cover"
              style={{
                backgroundImage: "url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80')"
              }}>
          ...
          <div className="container relative mx-auto">
              <div className="items-center flex flex-wrap">
                <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                  <div  data-aos="fade-up"  className="pr-12" >
                    <h1 className="text-white font-semibold text-5xl">
                      Your story starts with us.
                    </h1>
                    <p data-aos="fade-right"  data-aos-delay="1000" className="mt-4 text-lg text-gray-300">
                      This is a simple example of a Landing Page you can build
                      using our company. It features multiple CSS
                      components based on our design system.
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center" data-aos="fade-right" data-aos-delay="1200">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Professional Instructors</h6>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto" data-aos="zoom-in-right">
                ...
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                  The program comes with three pre-built  to help you get
                  started faster. You can change it  and
                  you're good to go. Just make sure you JOIN US.
                </p>
                <a
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4" data-aos="flip-right" data-aos-delay="1000">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1548690312-e3b507d8c110?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"
                />
              </div>
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4" data-aos="zoom-in-left">
                <div className="md:pr-12">
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-gray-600">
                    The program comes with three  to help you
                    get started faster. You can change it  and
                    you're good to go.
                  </p>
            ...
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed m-4 text-gray-600">
                 We have professional instructors who are available to direct you into your goal and achive your shape.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4" data-aos="fade-in" data-aos-delay="600">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-gray-500 uppercase font-semibold">
                    Fitness Instructor and Group Instructor
                    </p>
                    <div className="mt-6">
                      <button
                        className="bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
